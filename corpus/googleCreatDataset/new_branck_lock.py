...
def lock_compare_unique(page2,bm25,data_unique2all,data_all2unique,data_output_path,page2_dir,diff_max,diff_png):
...
if __name__ == '__main__':
    ...
    new_branck=3
    current_action_list_before=[]
    while random_index<len(all_unique_page["data"]):
        ...
        if skipFlag==False:
            ...
            if len(current_action_list_before)==0:
                current_action_list_before=action_list_before[:]

            if name_before in dict_page_child:
                if len(dict_page_child[name_before])==0:
                    if data_all2unique[name_before]!=name_before:
                        bm25,data_unique2all,data_all2unique=lock_compare_unique(name_before,bm25,data_unique2all,data_all2unique,data_output_path,temp_save_path,diff_max,diff_png)
                        if data_all2unique[name_before]!=name_before:
                            current_action_list_before=[] #if this page is same with before page, no new branch
                        else:
                            shutil.copy(data_output_path+temp_save_path+"/"+name_before+"-html.txt",
                                data_output_path+name_before+"/"+name_before+"-html.txt")
                            shutil.copy(data_output_path+temp_save_path+"/"+name_before+"-xml.txt",
            ...
            for action_res in current_action_list_before:
                ...
                if "[Fail]:" in last_action_result or xml_source==None or skipFlag ==True:
                    ...
                    fail_index=current_action_list_before.index(action_res)
                    current_action_list_before[fail_index]="none"
                    break
            ...
            if action_after_Flag==False and action_fail_Flag == False: 
